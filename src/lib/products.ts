...
export const products: Product[] = [
  ...
  {
    id: "vertical-1350l",
    name: "Vertical Cylindrical Tank — 1,350 Litres",
    capacity: 1350,
    price: 10300,
    originalPrice: 12875,
    salePrice: 10300,
    onSale: true,
    slug: "vertical-cylindrical-tank-1350-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
      "1,350-litre capacity",
      "Vertical cylindrical design",
      "Space-efficient",
      "Durable construction",
      "UV resistant",
  ...
  {
    id: "vertical-1900l",
    name: "Vertical Cylindrical Tank — 1,900 Litres",
    capacity: 1900,
    price: 12800,
    originalPrice: 16000,
    salePrice: 12800,
    onSale: true,
    slug: "vertical-cylindrical-tank-1900-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
      "1,900-litre capacity",
      "Vertical cylindrical design",
      "Space-efficient",
      "Durable construction",
      "UV resistant",
  ...
  {
    id: "vertical-2500l",
    name: "Vertical Cylindrical Tank — 2,500 Litres",
    capacity: 2500,
    price: 15500,
    originalPrice: 19375,
    salePrice: 15500,
    onSale: true,
    slug: "vertical-cylindrical-tank-2500-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
      "2,500-litre capacity",
      "Vertical cylindrical design",
      "Space-efficient",
      "Durable construction",
      "UV resistant",
  ...
  {
    id: "vertical-4000l",
    name: "Vertical Cylindrical Tank — 4,000 Litres",
    capacity: 4000,
    price: 22500,
    originalPrice: 28125,
    salePrice: 22500,
    onSale: true,
    slug: "vertical-cylindrical-tank-4000-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
  ...
  {
    id: "vertical-16000l",
    name: "Vertical Cylindrical Tank — 16,000 Litres",
    capacity: 16000,
    price: 96500,
    originalPrice: 120625,
    salePrice: 96500,
    onSale: true,
    slug: "vertical-cylindrical-tank-16000-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
      "16,000-litre capacity",
      "Vertical cylindrical design",
      "Space-efficient",
      "Durable construction",
      "UV resistant",
  ...
  {
    id: "vertical-20000l",
    name: "Vertical Cylindrical Tank — 20,000 Litres",
    capacity: 20000,
    price: 126500,
    originalPrice: 158125,
    salePrice: 126500,
    onSale: true,
    slug: "vertical-cylindrical-tank-20000-litres",
    description: "Vertical cylindrical tank designed for efficient water storage. Durable and space-saving design for residential and commercial use.",
    features: [
