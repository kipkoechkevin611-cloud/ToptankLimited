...
export const products: Product[] = [
  // TANKS - Standard Cylindrical Tanks
  {
    id: "standard-100l",
    ...
    description: "The one-piece, seamless tanks are molded from 100 % Food and Drug Administration (FDA) approved material and will not rust or impart any taste. The corrugated body allows it to stand upright making it more durable and easy to use.",
    features: [
    ...
    images: ["/bins/100l Standard Cylindrical Tank.jpg", "/bins/100l Standard Cylindrical Tank5.jpg"],
    category: "TANKS",
    subcategory: "Standard Cylindrical"
  },
  {
    id: "standard-200l",
  ...
  },
  {
    ...
    images: ["/TANKS/Rectangular Loft Tank/Rectangular Loft Tank.jpg"],
    category: "TANKS",
    subcategory: "Standard Cylindrical"
  },
  {
    ...
    images: ["/TANKS/deluxe cylindrical tank/Deluxe Cylindrical Tank.jpeg"],
    category: "TANKS",
    subcategory: "Standard Cylindrical"
  },
  {
  ...
  // TANKS - Nestable Tanks
  {
    ...
    inStock: true,
    image: "/TANKS/Nestable Tank.jpg",
    images: ["/TANKS/Nestable Tank.jpg"],
    category: "TANKS",
  ...
  // LIFESTYLE - TopDesk School Chair
  {
    ...
    inStock: true,
    image: "/Lifestyle/Large Round Beige Planter Pot/LACPLNTS09_Beige_1-100x100.jpg",
    images: ["/Lifestyle/Large Round Beige Planter Pot/LACPLNTS09_Beige_1-100x100.jpg"],
    category: "Lifestyle",
  ...
  // ROAD SAFETY & INDUSTRIAL - Road Traffic Triangle
  {
    ...
    images: [
      ...
      "/Road Safety & Industrial/Road Traffic Triangle1.png"
    ],
    category: "Road Safety & Industrial",
  ...
  },
  {
    ...
    images: [
      ...
      "/Sanitation/170cm PE Manhole2.jpg"
    ],
    category: "Sanitation",
    subcategory: "Manholes"
  },
  {
    ...
    inStock: true,
    image: "/Sanitation/190cm PE Manhole.jpg",
    images: [
      "/Sanitation/190cm PE Manhole.jpg",
  ...
  {
    id: "barrel-drum",
    name: "TopTank Barrel Drum",
    capacity: 200,
    price: 5700,
    slug: "toptank-barrel-drum",
    description: "Durable barrel drum for versatile storage applications. Ideal for agricultural and industrial use.",
    features: [
      "Heavy-duty construction",
  ...
  // BINS - 60litre Garbage Bin With Foot Pedal
  {
    ...
    images: [
      ...
      "/bins/60litre Garbage Bin With Foot Pedal8.jpg",
      "/bins/60litre Garbage Bin With Foot Pedal9.jpg"
    ],
    category: "bins",
  ...
  // BINS - 90litre Garbage Bin With Wheels & Handle
  {
    ...
    images: [
      ...
      "/bins/90litre Garbage Bin With Wheels & Handle6.jpg"
    ],
    category: "bins",
    subcategory: "Garbage Bins"
  },
  ...
  // BINS - 90litre Hexagonal Dustbin
  {
    ...
    images: [
      ...
      "/bins/90litre Hexagonal Dustbin5.jpg"
    ],
    category: "bins",
