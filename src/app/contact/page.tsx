...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[CONTACT] Server action response:', result);
      ...
      console.log('[CONTACT] Conversion tracked and form reset');
    } catch (error) {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black bg-white ${errors.subject ? 'border-red-500' : 'border-gray-300'}`}
                    required
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black ${errors.message ? 'border-red-500' : 'border-gray-300'}`}
